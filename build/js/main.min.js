  ...
  buttons.forEach(function (button) {
    button.addEventListener('click', function () {
      ...
      navList.forEach(function (listItem) {
        var isClosed = listItem.classList.contains('nav__list--is-closed');
...
},{"./modules/form-validate/form":3,"./utils/ios-vh-fix":10,"./vendor/init-swiper":11,"./vendor/init-video":12}],2:[function(require,module,exports){
"use strict";
...
},{"./swiper":13}],12:[function(require,module,exports){
"use strict";
