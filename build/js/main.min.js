...
var _initVideo = require("./vendor/init-video");
var _toggleIframe = _interopRequireDefault(require("./vendor/toggle-iframe"));
var _toggleMenu = _interopRequireDefault(require("./vendor/toggle-menu"));
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _initSwiper.initSwiper)(_initSwiper.heroSwiper);
  (0, _initSwiper.initSwiper)(_initSwiper.toursSwiper);
  (0, _initSwiper.initSwiper)(_initSwiper.trainingSwiper);
  (0, _initSwiper.initSwiper)(_initSwiper.reviewsSwiper);
  (0, _initSwiper.initSwiper)(_initSwiper.gallerySwiper);
  (0, _initSwiper.handleSwiper)();
  (0, _toggleIframe.default)();
...
},{"./modules/form-validate/form":3,"./vendor/init-swiper":9,"./vendor/init-video":10,"./vendor/toggle-iframe":12,"./vendor/toggle-menu":13}],2:[function(require,module,exports){
"use strict";
...
var Form = exports.Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function _initValidate(parent) {
      ...
      form.addEventListener('submit', function (event) {
        if (_this4.validateForm(event.target)) {
          if (_this4.isEmailAndPhoneValid(event.target)) {
    ...
    key: "isEmailAndPhoneValid",
    value: function isEmailAndPhoneValid(form) {
...
var getMailRegEx = exports.getMailRegEx = function getMailRegEx() {
  return /[a-zA-Zа-яёА-ЯЁ0-9]{1}([a-zA-Zа-яёА-ЯЁ0-9\-_\.]{1,})?@[a-zA-Zа-яёА-ЯЁ0-9\-]{1}([a-zA-Zа-яёА-ЯЁ0-9.\-]{1,})?[a-zA-Zа-яёА-ЯЁ0-9\-]{1}\.(?:[a-zA-Zа-яёА-ЯЁ]{2,6}|рф)/;
};
...
var Message = exports.Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    ...
    value: function removeMessage(parent) {
      var formInput = parent.querySelector('.form__input');
      if (formInput) {
    ...
    key: "renderMessage",
    value: function renderMessage(parent, validationState) {
...
exports.handleSwiper = handleSwiper;
exports.heroSwiper = void 0;
exports.initSwiper = initSwiper;
exports.trainingSwiper = exports.toursSwiper = exports.reviewsSwiper = void 0;
var _swiper = _interopRequireDefault(require("./swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var loopDisabled = false;
var loopEnabled = true; // loop: false для hero блока

var heroSwiperLoop = loopEnabled;
var toursSwiperLoop = loopDisabled;
var trainingSwiperLoop = loopDisabled;
var reviewsSwiperLoop = loopDisabled;
var advantagesSwiperLoop = loopDisabled;
var gallerySwiperLoop = loopEnabled;
...
var heroSwiper = exports.heroSwiper = new _swiper.default('[data-swiper="hero"]', heroSwiperOptions);
var toursSwiper = exports.toursSwiper = new _swiper.default('[data-swiper="tours"]', toursSwiperOptions);
var trainingSwiper = exports.trainingSwiper = new _swiper.default('[data-swiper="training"]', trainingSwiperOptions);
var reviewsSwiper = exports.reviewsSwiper = new _swiper.default('[data-swiper="reviews"]', reviewsSwiperOptions);
var gallerySwiper = exports.gallerySwiper = new _swiper.default('[data-swiper="gallery"]', gallerySwiperOptions);
function handleSwiper() {
  if (desktop.matches) {
    if (!advantagesSwiper) {
      advantagesSwiper = new _swiper.default('[data-swiper="advantages"]', advantagesSwiperOptions);
    }
  } else {
    if (advantagesSwiper) {
...
},{"./swiper":11}],10:[function(require,module,exports){
"use strict";
...
function findVideos() {
  var videos = document.querySelectorAll('[data-video="video-container"]');
  for (var i = 0; i < videos.length; i++) {
    setupVideo(videos[i]);
  }
}
function setupVideo(video) {
  var link = video.querySelector('[data-video="video-link"]');
  var media = video.querySelector('[data-video="video-media"]');
...
function toggleIframe() {
  var wrapper = document.querySelector('.hero__vidget-wrapper');
  var button = wrapper.querySelector('.hero__vidget-button');
...
var _default = exports.default = toggleIframe;
...
function toggleMenu() {
  ...
  var navList = document.querySelectorAll('[data-menu="menu"]');
  var nav = document.querySelector('[data-menu="layer"]');
  var logo = document.querySelector('[data-menu="menu-logo"]');
  var telephone = document.querySelector('[data-menu="menu-telephone"]');
  var overlay = document.querySelector('[data-menu="menu-overlay"]');
  var body = document.body;
  var iconMenuIsClosed = document.querySelector('[data-menu="menu-is-closed"]');
  var iconMenuIsOpened = document.querySelector('[data-menu="menu-is-opened"]');
  function handleButtonClick() {
    var firstNavItem = navList[0];
...
var _default = exports.default = toggleMenu;
